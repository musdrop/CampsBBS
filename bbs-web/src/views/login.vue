    ...
    <div class="login">
        ...
        <div class="login-card">
            <el-form ref="loginFormRef" :model="loginForm" :rules="loginRules" class="login-form">
                <!-- 标题 -->
                <h2 class="title">NUAA校园论坛 · 用户登录</h2>

                <!-- 账号表单项 -->
                <el-form-item prop="account">
                    <el-input v-model="loginForm.account" clearable prefix-icon="User" placeholder="请输入账号" />
                </el-form-item>
                ...
                <el-form-item class="button-container">
                    <div class="button-row">
                        <el-button type="primary" @click="doLogin" class="login-button">登录</el-button>
                        <el-button type="default" @click="toRegister" class="register-button">注册账号</el-button>
                    </div>
                </el-form-item>
            </el-form>
        </div>
